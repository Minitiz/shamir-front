      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Secure Quorum offers a robust file storage solution where access and editing require a minimum quorum of authorized keys, ensuring that your sensitive data is protected and only accessible by a consensus of trusted users.</h2>
